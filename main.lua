...
-- Nombres autorizados (en minúsculas para evitar errores de escritura)
local Whitelist = {
...
Title.Text = "HRX PRIVADO | Fast Farming - Hey, " .. LocalPlayer.Name .. "!"
...
local RebirthsPage     = CreateTab("Rebirths", 1)
local StrengthMainPage = CreateTab("Strength Main", 2)
local StrengthLagPage  = CreateTab("Strength Lag", 3)
...
AddLabel(RebirthsPage, "Status: Active", PRIMARY_COLOR)
